...
import gdil.gateway.config.Constants;
import gdil.gateway.domain.User;
import gdil.gateway.repository.UserRepository;
import gdil.gateway.security.AuthoritiesConstants;
import gdil.gateway.service.MailService;
import gdil.gateway.service.UserService;
import gdil.gateway.service.dto.AdminUserDTO;
import gdil.gateway.web.rest.errors.BadRequestAlertException;
import gdil.gateway.web.rest.errors.EmailAlreadyUsedException;
import gdil.gateway.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link gdil.gateway.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
