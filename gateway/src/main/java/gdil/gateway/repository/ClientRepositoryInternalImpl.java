...
import gdil.gateway.repository.rowmapper.ClientRowMapper;
import gdil.gateway.repository.rowmapper.UserRowMapper;
...
class ClientRepositoryInternalImpl extends SimpleR2dbcRepository<Client, Long> implements ClientRepositoryInternal {
    ...
    private static final Table userTable = Table.aliased("gdil_user", "e_user");
