package gdil.commande.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import gdil.commande.IntegrationTest;
import gdil.commande.repository.timezone.DateTimeWrapper;
import gdil.commande.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM gdil_date_time_wrapper where id=%d", fieldName, id);
    }
